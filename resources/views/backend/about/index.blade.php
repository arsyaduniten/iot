...
<div class="container mx-auto">
    <table class="border border-grey-dark m-2">
        ...
        <tr class="">
            ...
            <td class="p-2 py-4">
                <form id="delete-form-{{ $about->id }}" action="{{ route('backend:about:destroy', ['about' => $about]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="text-white font-bold no-underline p-2 bg-red delete-btn" data-id="{{ $about->id }}" type="submit">Delete</button>
                </form>
            </td>
        </tr>
        @endforeach
