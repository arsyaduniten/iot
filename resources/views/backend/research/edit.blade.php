...
<form id="editForm" class="container mx-auto flex flex-col w-1/2" method="POST" action="{{ route('backend:research:update', ['research' => $research]) }}">
	@csrf
	@method('PUT')
	{{-- <div class="flex">
	...
	<div class="flex">
		...
		<div class="flex flex-col">
			<input class="self-center m-2 p-2 bg-white shadow-md rounded" type="text" name="research_area" value="{{ $research->research_area }}">
	...
	<div class="flex">
		...
		<div class="flex flex-col">
			<input class="self-center m-2 p-2 bg-white shadow-md rounded datepick" type="date" name="start_date" value="{{ $research->start_date }}">
	...
	<div class="flex">
		...
		<div class="flex flex-col">
			<input class="self-center m-2 p-2 bg-white shadow-md rounded datepick" type="date" name="end_date" value="{{ $research->end_date }}">
