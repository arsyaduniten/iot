	...
	<div class="flex">
		...
		<div class="text-left w-full h-screen mt-16 ml-250" >
			...
			<div class="flex flex-col h-full overflow-x-scroll p-4">
				...
				<p class="hidden total_fund pt-4 text-xl this-black">Total Funding: <span class="font-bold">MYR {{ number_format($total_funding) }}</span> | <span class="font-bold">USD {{ number_format($usd) }}</span></p>
			        <tr class="bg-grey p-5 text-left">
