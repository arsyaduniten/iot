		...
		<div class="flex flex-col text-center w-full">
			...
			<div class="flex w-full container mx-auto justify-around m-8">
				<div class="flex flex-col bg-blue-custom-dark shadow p-6 m-4 rounded">
					<p class="text-2xl font-bold text-purple-dark">12</p>
					<p class="text-purple-dark pt-4">Years of Experience</p>
				</div>
				<div class="flex flex-col bg-blue-custom-dark shadow p-6 m-4 rounded">
					<p class="text-2xl font-bold text-purple-dark">30</p>
					<p class="text-purple-dark pt-4">Publications</p>
				</div>
				<div class="flex flex-col bg-blue-custom-dark shadow p-6 m-4 rounded">
					<p class="text-2xl font-bold text-purple-dark">10,000</p>
					<p class="text-purple-dark pt-4">In Funding</p>
				</div>
				<div class="flex flex-col bg-blue-custom-dark shadow p-6 m-4 rounded">
					<p class="text-2xl font-bold text-purple-dark">5</p>
